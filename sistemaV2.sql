...
CREATE SEQUENCE public.people_peopl_id_seq;

CREATE TABLE public.people (
                peopl_id INTEGER NOT NULL DEFAULT nextval('public.people_peopl_id_seq'),
                ...
                CONSTRAINT people_pk PRIMARY KEY (peopl_id)
);


ALTER SEQUENCE public.people_peopl_id_seq OWNED BY public.people.peopl_id;
...
REFERENCES public.people (peopl_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
